...
Shader "Shader Forge/Ground" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_9757; uniform float4 _node_9757_ST;
...
////// Lighting:
                ...
                float4 _node_9757_var = tex2D(_node_9757,TRANSFORM_TEX(i.uv0, _node_9757));
                float3 finalColor = lerp(Background,node_9624,_node_9757_var.a);
