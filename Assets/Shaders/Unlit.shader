...
Shader "Shader Forge/Unlit" {
    Properties {
        ...
        _RimPowe ("RimPowe", Range(0, 2)) = 0.1092763
        _RimIntensity ("RimIntensity", Range(0, 5)) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
